							...
							<div id="playlist">
								...
								<div class="card-body d-flex">
									<div class="card-img">
										...
										<i onclick="searchKey('후라이의꿈')" class="bi bi-play-circle me-3"
											style="font-size: 35px;"></i> <a href="찜"> 
											<i class="bi bi-arrow-through-heart-fill"
...
var player = document.querySelector("#playlist > div.card-body.d-flex > div > div");
	...
	$.ajax({
		...
		success : function onYouTubeIframeAPIReady(result){
			...
			document.querySelector(".player").classList.add('d-none');
